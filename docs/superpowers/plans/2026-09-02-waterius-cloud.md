...
Корень: `C:\Users\user\Desktop\claude\ha-waterius-cloud`. Все пути ниже — относительно него.
...
```bash
cd /c/Users/user/Desktop/claude/ha-waterius-cloud
git init -b main
```
...
```bash
cp /c/Users/user/Desktop/claude/ha-razliv-snt/LICENSE ./LICENSE
```
